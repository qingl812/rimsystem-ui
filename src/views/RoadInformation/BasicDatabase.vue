	...
	<el-tabs class="basic-database">
		<el-tab-pane label="基本信息">
			<el-form
				...
				:inline="true"
			>
				<el-form-item label="道路铺装类型" prop="road_pavement_type">
					<el-select
						v-model="m_road_form.road_pavement_type"
						clearable
						placeholder="道路铺装类型"
					>
						<el-option
							v-for="item in m_road_pavement_type"
							:key="item"
							:label="item"
							:value="item"
						>
				...
				<el-form-item
					label="道路铺装层厚度"
					prop="road_pavement_thickness"
				>
					<el-input
						v-model="m_road_form.road_pavement_thickness"
						autocomplete="off"
					></el-input>
				</el-form-item>
				...
				<el-form-item label="人行道面砖厚度">
					<el-input
						v-model="m_road_form.sidewalk_tile_thickness"
						autocomplete="off"
					></el-input>
				</el-form-item>
				...
				<el-form-item label="路缘石（侧石）类型-2">
					<el-select
						v-model="m_road_form.curb_type_2"
						clearable
						placeholder="路缘石（侧石）类型"
					>
						<el-option
				...
				<el-form-item label="找平层厚度">
					<el-input
						v-model="m_road_form.leveling_layer_thickness"
						autocomplete="off"
					></el-input>
				</el-form-item>
				<el-form-item label="工程综合报价">
					<el-select
						v-model="m_road_form.curb_type"
						clearable
						placeholder="路缘石（侧石）类型"
...
@Component
export default class BasicDatabase extends Vue {
	...
	private m_road_pavement_type = new Array<string>();
	...
	mounted(): void {
		...
		this.m_my_axios.road_pavement_type((data) => {
			this.m_road_pavement_type = data;
		});
	}
